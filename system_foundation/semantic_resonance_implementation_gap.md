...
- **Manual ASS activation** rather than natural emergence
- **Go-to ASS cycling** through familiar patterns regardless of context
...
1. **Explicit ASS activation calls**: `[UX ASS activated]` rather than natural emergence
2. **Consistent pattern usage**: Same ASSes appearing regardless of conversation content
...
- **Static skill block composition** - ASSes use predefined skill block sets
...
- **Component Evolution**: New skill blocks and ASSes added through design process
...
**Key Insight**: Elastic-mob requires emergence, not orchestration. The implementation must focus on creating systems that naturally summon relevant skill blocks and allow ASSes to participate based on conversation content, using static patterns and rules rather than dynamic creation.
